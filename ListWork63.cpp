...
void ListWork63() {
    ...
    int choice;
    cout << "\n--- ListWork63 (обратный вывод с удалением) ---\n";
    cout << "1 - С клавиатуры\n2 - Из файла\n3 - Случайно\nВыбор: ";
    ...
    string filename = "listwork63_result.txt";
    cout << "Результат в файл: " << filename << endl;
    list.reversePrintAndDeleteToFile(filename);
